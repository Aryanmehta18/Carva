            ...
            if (navigator.share) {
              navigator
                .share({
                  ...
                  text: `Check out this ${car.year} ${car.make} ${car.model} on Ve!`,
  ...
  return (
    <div>
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex gap-2 overflow-x-auto pb-2">{car.images.map((image,index)=>{
            return (
                <div
                key={index}
